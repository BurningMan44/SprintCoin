    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SPRINT-light"), QVariant("light"));
    ui->theme->addItem(QString("SPRINT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SPRINT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SPRINT-traditional"), QVariant("trad"));
