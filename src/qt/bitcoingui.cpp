    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sprint Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sprint address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sprint: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sprint Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sprint Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sprint Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sprint addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sprint addresses"));
    ...
    openAction->setStatusTip(tr("Open a sprint: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sprint Core help message to get a list with possible Sprint Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sprint Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sprint network", "", count));
}
...
{
    QString strTitle = tr("Sprint Core"); // default title
