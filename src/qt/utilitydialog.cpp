    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sprint Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sprint Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sprint-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sprint in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPRINT, 0.1 SPRINT, 1 SPRINT and 10 SPRINT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sprintpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sprintpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sprint Core is shutting down...") + "<br /><br />" +
