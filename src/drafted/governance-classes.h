 ...
 *
 *   // network
 *   CSprintNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sprint.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSprintNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SprintNetwork
// //   -- signature requirements : Key1(User)
// class CSprintNetworkVariable : public CGovernanceObject
// {
// private:
