...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SprintNetwork") type = SprintNetwork;
    if(strType == "SprintNetworkVariable") type = SprintNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SprintNetwork) s = "SprintNetwork";
    if(type == SprintNetworkVariable) s = "SprintNetworkVariable";
