...
{
    if(fLiteMode) return; // ignore all Sprint related functionality
...
/*
    ...
    allow endless transaction that would bloat Sprint and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("sprint-privatesend");
