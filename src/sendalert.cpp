...
2. run sprintd with -printalert or -sendalert like this:
   /path/to/sprintd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.sprint.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Sprint Core:0.12.0.58/"));
