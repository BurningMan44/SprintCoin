...
Only requiring some minor changes is sprint.cpp.
...
Changes to sprint.cpp
----------------------
sprint.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
