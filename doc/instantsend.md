...
This mechanism has been integrated into Bitcore-Node-Sprint which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sprintpay/insight-api-sprint#web-socket-api](https://github.com/sprintpay/insight-api-sprint#web-socket-api) 
* API: [https://github.com/sprintpay/insight-api-sprint#instantsend-transactions](https://github.com/sprintpay/insight-api-sprint#instantsend-transactions) 
...
By default, the Sprint Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sprint Core daemon:
